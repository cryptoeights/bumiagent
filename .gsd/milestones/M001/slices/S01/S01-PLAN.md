...
- [ ] **T01: Foundry project setup + interfaces** `est:20m`
...
- [ ] **T02: EarthPool.sol + tests** `est:30m`
...
- [ ] **T03: SpawnRegistry.sol + tests** `est:45m`
...
- [ ] **T04: AgentCommerce.sol + tests** `est:45m`
...
- [ ] **T05: Deploy script + integration smoke test** `est:20m`
