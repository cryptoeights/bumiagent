...
- [x] **T01: Backend project setup + DB schema** `est:25m`
...
- [x] **T02: Agent registration endpoint + wallet encryption** `est:30m`
...
- [x] **T03: Templates data + OpenRouter chat endpoint** `est:30m`
...
- [x] **T04: Rate limiting + env validation + contract ABIs** `est:20m`
